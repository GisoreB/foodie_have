...
import 'package:foodie_have/core/network/network_service.dart';
import 'package:foodie_have/features/categories/data/datasources/category_datasource.dart';
import 'package:foodie_have/features/categories/data/repositories/category_repository_impl.dart';
...
import 'package:foodie_have/features/meals/data/datasources/meal_datasource.dart';
import 'package:foodie_have/features/meals/data/repositories/meal_repository_impl.dart';
import 'package:foodie_have/features/meals/domain/repositories/meal_repository.dart';
import 'package:foodie_have/features/meals/domain/usecases/get_meal_by_id_usecase.dart';
import 'package:foodie_have/features/meals/domain/usecases/get_meal_list_usecase.dart';
import 'package:foodie_have/features/meals/domain/usecases/list_meals_by_first_letter_usecase.dart';
import 'package:foodie_have/features/meals/domain/usecases/lookup_random_meal_usecase.dart';
import 'package:foodie_have/features/meals/domain/usecases/search_meals_by_name_usecase.dart';
import 'package:foodie_have/features/meals/presentation/bloc/meals_bloc.dart';
